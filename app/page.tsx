          ...
          <div className="mx-auto">
            <div className="">
              <div className="mx-auto px-4 sm:px-6 lg:px-8 pt-24 space-y-8">
                ...
                <a href="/dash" className="transition m-1 inline-flex p-4 justify-center items-center gap-x-3 text-center text-white border bg-black hover:bg-blue-600 border-black text-sm font-bold rounded-full">
                    Casos de Exito
                  </a>
